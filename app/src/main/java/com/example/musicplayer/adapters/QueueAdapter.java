        ...
        if (fragment == null) {
            if (MediaPlayerService.activeAudio != null) {
                if (MediaPlayerService.activeAudio.getId() == MediaPlayerService.audioList.get(position).getId() && MediaPlayerService.audioIndex == position) {
                    holder.queue_song_title.setTextColor(context.getResources().getColor(R.color.blue41));
                    holder.queue_song_artist.setTextColor(context.getResources().getColor(R.color.blue41));
                } else {
                    holder.queue_song_title.setTextColor(context.getResources().getColor(R.color.black));
