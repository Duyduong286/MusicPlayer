        ...
        switch (holder.getItemViewType()){
            ...
            case TYPE_SONG:
                ...
                if (x!=-1) {
                    ...
                    text.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.bluec1)), x, x + query.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
                ...
                Glide.with(holder0.iv_album_art).load(ContentUris.withAppendedId(Uri.parse("content://media/external/audio/albumart"), songs.get(position-1).getAlbumid()))
                        .error(R.mipmap.ic_launcher_wave)
                        .placeholder(R.mipmap.ic_launcher_wave)
                        .centerCrop()
                        .fallback(R.mipmap.ic_launcher_wave)
            ...
            case TYPE_ALBUM:
                ...
                if (y!=-1) {
                    ...
                    text.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.bluec1)), y, y + query.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
                ...
                Glide.with(holder1.albums_album_art).load(albums.get(position-songSize-1).getAlbumArt())
                        .centerCrop().error(R.drawable.ic_artist_blue).into(holder1.albums_album_art);

                if (isSelected(position)) {
                    holder1.itemView.setBackgroundColor(context.getResources().getColor(R.color.bluec1));
                    holder1.albums_popup_menu.setClickable(false);
                }
                else {
                    holder1.itemView.setBackgroundColor(context.getResources().getColor(R.color.colorBG));
            ...
            case TYPE_ARTIST:
                ...
                if (z!=-1) {
                    ...
                    text.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.bluec1)), z, z + query.length(), Spannable.SPAN_INCLUSIVE_INCLUSIVE);
                ...
                if (isSelected(position)) {
                    holder2.itemView.setBackgroundColor(context.getResources().getColor(R.color.bluec1));
                    holder2.artists_popup_menu.setClickable(false);
                }
                else {
                    holder2.itemView.setBackgroundColor(context.getResources().getColor(R.color.colorBG));
