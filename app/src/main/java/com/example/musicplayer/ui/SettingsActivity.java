    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                else if (checkedId == R.id.radioButton_home) preferences.edit().putString("START", "Home").apply();
        ...
        final CheckBox checkbox_home = findViewById(R.id.checkbox_home);

        checkbox_home.setChecked(preferences.getBoolean("HOME", true));

        checkbox_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if (checkbox_home.isChecked() && preferences.getInt("BROWSERS", 6) != 1){
                    preferences.edit().putBoolean("HOME", true).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) + 1).apply();
                }
                else if (!checkbox_home.isChecked() && preferences.getInt("BROWSERS", 6) == 1){
                    Toast.makeText(SettingsActivity.this , "Atleast one browser must be visible", Toast.LENGTH_SHORT).show();
                    checkbox_home.setChecked(true);
                }
                else{
                    preferences.edit().putBoolean("HOME", false).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) - 1).apply();
                }
        ...
        checkbox_songs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkbox_songs.isChecked() && preferences.getInt("BROWSERS", 6) != 1){
                    preferences.edit().putBoolean("SONGS", true).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) + 1).apply();
                }
                else if (!checkbox_songs.isChecked() && preferences.getInt("BROWSERS", 6) == 1){
                    Toast.makeText(SettingsActivity.this , "Atleast one browser must be visible", Toast.LENGTH_SHORT).show();
                    checkbox_songs.setChecked(true);
                }
                else{
                    preferences.edit().putBoolean("SONGS", false).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) - 1).apply();
                }
        ...
        checkbox_albums.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkbox_albums.isChecked() && preferences.getInt("BROWSERS", 6) != 1){
                    preferences.edit().putBoolean("ALBUMS", true).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) + 1).apply();
                }
                else if (!checkbox_albums.isChecked() && preferences.getInt("BROWSERS", 6) == 1){
                    Toast.makeText(SettingsActivity.this, "Atleast one browser must be visible", Toast.LENGTH_SHORT).show();
                    checkbox_albums.setChecked(true);
                }
                else{
                    preferences.edit().putBoolean("ALBUMS", false).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) - 1).apply();
                }
        ...
        checkbox_artists.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkbox_artists.isChecked() && preferences.getInt("BROWSERS", 6) != 1){
                    preferences.edit().putBoolean("ARTISTS", true).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) + 1).apply();
                }
                else if (!checkbox_artists.isChecked() && preferences.getInt("BROWSERS", 6) == 1){
                    Toast.makeText(SettingsActivity.this, "Atleast one browser must be visible", Toast.LENGTH_SHORT).show();
                    checkbox_artists.setChecked(true);
                }
                else{
                    preferences.edit().putBoolean("ARTISTS", false).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) - 1).apply();
                }
        ...
        checkbox_folders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkbox_folders.isChecked() && preferences.getInt("BROWSERS", 6) != 1){
                    preferences.edit().putBoolean("FOLDERS", true).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) + 1).apply();
                }
                else if (!checkbox_folders.isChecked() && preferences.getInt("BROWSERS", 6) == 1){
                    Toast.makeText(SettingsActivity.this, "Atleast one browser must be visible", Toast.LENGTH_SHORT).show();
                    checkbox_folders.setChecked(true);
                }
                else{
                    preferences.edit().putBoolean("FOLDERS", false).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) - 1).apply();
                }
        ...
        checkbox_playlists.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkbox_playlists.isChecked() && preferences.getInt("BROWSERS", 6) != 1){
                    preferences.edit().putBoolean("PLAYLISTS", true).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) + 1).apply();
                }
                else if (!checkbox_playlists.isChecked() && preferences.getInt("BROWSERS", 6) == 1){
                    Toast.makeText(SettingsActivity.this, "Atleast one browser must be visible", Toast.LENGTH_SHORT).show();
                    checkbox_playlists.setChecked(true);
                }
                else{
                    preferences.edit().putBoolean("PLAYLISTS", false).putInt("BROWSERS", preferences.getInt("BROWSERS", 6) - 1).apply();
                }
