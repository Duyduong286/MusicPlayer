...
public class NowPlaying extends AppCompatActivity implements ItemClicked, PlaylistItemClicked {
    ...
    private TextView song_title, song_artist_album, song_number, now_playing_current_position, now_playing_duration;
    private SeekBar now_playing_seekbar;
    ...
    private void buttonControls() {
        ...
        if (MediaControllerCompat.getMediaController(NowPlaying.this).getRepeatMode() == PlaybackStateCompat.REPEAT_MODE_ALL)
            now_playing_repeat.setImageResource(R.drawable.ic_repeat);
        else if (MediaControllerCompat.getMediaController(NowPlaying.this).getRepeatMode() == PlaybackStateCompat.REPEAT_MODE_ONE)
            now_playing_repeat.setImageResource(R.drawable.ic_repeat_one);
...
//                startActivity(new Intent(this, EqualizerActivity.class));
    ...
    protected void onDestroy() {
        ...
        song_title = song_artist_album = song_number = now_playing_current_position = now_playing_duration = null;
        now_playing_seekbar = null;
