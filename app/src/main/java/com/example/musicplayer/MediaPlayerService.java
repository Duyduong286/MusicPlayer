...
public class MediaPlayerService extends MediaBrowserServiceCompat implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    private  int resumePosition;    //vị trí hiện tại của bài hát
        ...
        if (!mediaPlayer.isPlaying()) {
            ...
            if (MediaPlayerService.activeAudio.getAlbumid() != -100) {
                try {
                    ...
                    notificationBigContentView.setImageViewResource(R.id.big_cv_bg, R.mipmap.ic_launcher_wave);
                    notificationBigContentView.setImageViewResource(R.id.big_cv_small_album_art, R.mipmap.ic_launcher_wave);
                    notificationContentView.setImageViewResource(R.id.content_view_album_art, R.mipmap.ic_launcher_wave);
                }
            }
            else {
    ...
    private void setNotification() {
        ...
        notificationContentView.setImageViewResource(R.id.content_view_next, R.drawable.ic_next);
        ...
        notificationBigContentView.setImageViewResource(R.id.big_cv_next, R.drawable.ic_next);
